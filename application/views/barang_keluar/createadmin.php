        ...
        <div class="col-md-6">
            <div class="card" style="box-shadow: 0 0 10px rgba(0, 0, 0, 0.1);">
                ...
                <div class="card-body">
                    ...
                    <?php } ?>
                    <form action="<?php echo site_url('BarangKeluaradmin/store'); ?>" method="post">
                        ...
                        <div class="form-group">
                            ...
                            <input type="date" name="tanggal_keluar" class="form-control" value="<?php echo date('Y-m-d'); ?>" required>
                        </div>
                        <div class="form-group">
