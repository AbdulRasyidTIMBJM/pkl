...
<script>
    $(document).ready(function() {
        ...
        $('#konfirmasiCetak').click(function(e) {
            ...
            window.location.href = '<?= base_url('BarangRusak/cetak_surat_serah_terima') ?>?id_barang_rusak=' + idBarangRusak.join(',') + '&nama_pihak_pertama=' + namaPihakPertama + '&jabatan_pihak_pertama=' + jabatanPihakPertama + '&nama_pihak_kedua=' + namaPihakKedua + '&jabatan_pihak_kedua=' + jabatanPihakKedua;
        });
        $("#example1").DataTable({
            "responsive": false,
            "lengthChange": true,
