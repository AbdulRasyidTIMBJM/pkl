<main class="content-wrapper"> <!-- Ganti <main> dengan <div class="content-wrapper"> -->
    <div class="card-body">
            ...
            <div class="modal-dialog" role="document">
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        <form method="GET" action="<?php echo site_url('BarangMasukadmin/index'); ?>">
        ...
        <a href="<?php echo site_url('BarangMasukadmin/create'); ?>" class="btn btn-sm btn-success mr-2"><i class="fas fa-plus"></i> Tambah Data</a>
            ...
            <tbody>
                ...
                foreach ($barang_masuk as $bm): ?>
                    <tr>
                        ...
                        <td>
                            <?php if ($bm->status == 'Sudah Disterilkan') { ?>
                                <span class="badge badge-success"><?= $bm->status ?></span>
                            <?php } elseif ($bm->status == 'belum Disterilkan') { ?>
                        ...
                        <td>
                            <a href="<?= base_url('BarangMasukadmin/edit/' . $bm->id_barang_masuk) ?>" class="btn btn-sm mt-2 btn-primary">Edit</a>
                            <a href="<?= base_url('BarangMasukadmin/delete/' . $bm->id_barang_masuk) ?>" class="btn btn-sm mt-2 btn-danger" onclick="return confirm('Yakin ingin menghapus data?')">Hapus</a>
                        </td>
                    </tr>
                <?php endforeach; ?>
            </tbody>
            ...
            "buttons": [{
                ...
                },
                {
                    ...
                    action: function(e, dt, button, config) {
                        ...
                        window.open('<?php echo site_url('BarangMasukadmin/reprint'); ?>', '_blank');
                    },
                    className: 'btn btn-sm btn-success mr-2 mt-2'
                }
            ]
