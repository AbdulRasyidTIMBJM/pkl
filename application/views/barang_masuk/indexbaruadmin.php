<div class="content-wrapper"> <!-- Ganti <main> dengan <div class="content-wrapper"> -->
    <div class="card-body">
            ...
            <div class="modal-dialog" role="document">
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        <form method="GET" action="<?php echo site_url('BarangMasukadmin/indexbaru'); ?>">
        ...
        <!-- <a href="<?php echo site_url('BarangMasukadmin/createbaru'); ?>" class="btn btn-sm btn-success mr-2"><i class="fas fa-plus"></i> Tambah Data</a> -->
            ...
            <tbody>
                <?php $no = 1; foreach ($barang_masuk as $bm): ?>
                    <tr>
                        ...
                        <!-- <td>
                            <a href="<?= base_url('BarangMasukadmin/editbaru/' . $bm->id_barang_masuk) ?>" class="btn btn-sm mt-2 btn-primary">Edit</a>
