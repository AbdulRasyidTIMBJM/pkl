<main class="content-wrapper">
    <div class="container">
        ...
        <a href="<?= base_url('BarangMasukadmin/create_surat'); ?>" class="btn btn-success">Tambah Data</a> <!-- Tombol Tambah Data -->
            ...
            <tbody>
                <?php $no = 1; foreach ($barang_masuk as $bm): ?>
                    <tr>
                        ...
                        <td>
                            <a href="<?= base_url('BarangMasukadmin/edit_surat/' . $bm->id_barang_masuk); ?>" class="btn btn-warning btn-sm">Edit</a> <!-- Tombol Edit -->
                    ...
                    <form>
                        ...
                        <div class="form-group">
                            ...
                            <select name="id_supplier" class="form-control">
                                <?php foreach ($this->BarangMasukadmin_model->get_all_supplier() as $supplier) : ?>
    ...
    $(document).ready(function() {
        ...
        $('#cetakSurat').click(function() {
            ...
            if (idBarangMasuk.length > 0) {
                window.location.href = '<?= base_url('BarangMasukadmin/cetak_surat') ?>?id_barang_masuk=' + idBarangMasuk.join(',');
            } else {
        ...
        $('#applyFilter').click(function() {
            ...
            $.ajax({
                type: 'GET',
                url: '<?= base_url('BarangMasukadmin/get_barang_masuk_by_filter') ?>',
                data: {
                ...
                success: function(data) {
                    $('#dataBarangMasukadmin').html(data);
                }
            });
        });
    });
