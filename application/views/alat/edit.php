    ...
    <div class="row justify-content-center"> 
        <div class="col-md-6"> 
            <div class="card" style="box-shadow: 0 0 10px rgba(0, 0, 0, 0.1);"> 
                ...
                <div class="card-body"> 
                    <form action="<?php echo site_url('Alat/update/'); ?>" method="post"> 
                    <input type="hidden" name="id_alat" value="<?= $alat->id_alat ?>"> 
                        ...
                        <div class="form-group"> 
                            ...
                            <input type="number" name="merk" id="merk" class="form-control" value="<?php echo $alat->merk; ?>" required> 
                            <?php echo form_error('merk'); ?> 
                        </div> 
                        <div class="form-group"> 
                            <label for="spesifkasi">Spesifkasi:</label> 
                            <input type="number" name="spesifkasi" id="spesifkasi" class="form-control" value="<?php echo $alat->spesifkasi; ?>" required> 
                            <?php echo form_error('spesifkasi'); ?> 
                        </div> 
