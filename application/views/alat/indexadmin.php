<main class="content-wrapper">
  <div class="card-body">
    ...
    <?php } ?>
    <a href="<?php echo site_url('alatadmin/create'); ?>" class="btn btn-sm btn-success mr-2"><i class="fas fa-plus"></i> Tambah Data</a>
      ...
      <tbody>
        ...
        foreach ($alat as $a): ?>
          <tr>
            ...
            <td>
              <a href="<?= base_url('Alatadmin/edit/' . $a->id_alat) ?> ?>" class="btn btn-sm btn-primary">Edit</a>
              <a href="<?= base_url('Alatadmin/delete/' . $a->id_alat) ?>" class="btn btn-sm btn-danger" onclick="return confirm('Yakin ingin menghapus data?')">Hapus</a>
            </td>
          </tr>
        <?php endforeach; ?>
      </tbody>
      ...
      "buttons": [{
        ...
        },
        {
          ...
          action: function(e, dt, button, config) {
            ...
            window.open('<?php echo site_url('Alatadmin/print'); ?>', '_blank');
          },
          className: 'btn btn-sm btn-success mr-2 mt-2'
        }
      ]
